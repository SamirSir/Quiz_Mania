...
class SubjectsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subject" do
    assert_difference('Subject.count') do
      post subjects_url, params: { subject: { content: @subject.content, name: @subject.name } }
    end
  ...
  test "should update subject" do
    patch subject_url(@subject), params: { subject: { content: @subject.content, name: @subject.name } }
